...
//! - `EndpointId` edge cases (usize::MAX wrap, collision scenario)
//! - endpoint groups and sniffer-sysid behaviour
//! - `needs_update_for_endpoint` staleness logic
//! - stress / churn stability (scaled by core count)
